...
use The7\Adapters\Elementor\Pro\ThemeSupport;
...
class The7_Elementor_Theme_Builder_Adapter {
	...
	public function bootstrap() {
		...
		add_action( 'init', [ $this, 'support_theme_builder' ], 1 );
	...
	public function support_theme_builder(){
		require_once __DIR__ . '/theme-support/the7-theme-support.php';
